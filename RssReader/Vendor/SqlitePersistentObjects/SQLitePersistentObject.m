...
+(id)findFirstByCriteria2:(NSString *)criteriaString, ...
{
	// Added variadic ability to all criteria accepting methods -SLyons (10/03/2009)
	va_list argumentList;
...
+(id)findFirstByCriteria:(NSString *)criteriaString {
    return [self findFirstByCriteria2:criteriaString];
}
...
+(NSArray *)findByCriteria2:(NSString *)criteriaString {
    return [self findByCriteria:criteriaString];
}
